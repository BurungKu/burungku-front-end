            ...
            <Container>
                <div className="lg:h-screen pt-30 lg:pt-0 2xl:pt-0 flex items-center justify-center flex-col text-center">
                    ...
                    <div className="w-full md:w-[35rem] h-56 md:h-72 border rounded-3xl mt-10 relative overflow-hidden">
                        <img src={Rangkong} alt="Logo" className="absolute w-56 h-64 md:w-90 md:h-96 rotate-12 left-0 -ml-16 mt-5 md:mt-0"/>
                        <img src={KakaTua} alt="Logo" className="absolute w-56 h-64 md:w-90 md:h-96 right-0 -mr-22 mt-5 md:mt-0"/>
                    </div>
                </div>
            </Container>
